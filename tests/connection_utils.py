...
async def add_dummy_connection(
    server: ChivesServer, self_hostname: str, dummy_port: int, type: NodeType = NodeType.FULL_NODE
...
async def connect_and_get_peer(server_1: ChivesServer, server_2: ChivesServer, self_hostname: str) -> WSChivesConnection:
    """
