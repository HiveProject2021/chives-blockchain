...
from chives.protocols.shared_protocol import Capability, capabilities
from chives.server.start_farmer import create_farmer_service
from chives.server.start_full_node import create_full_node_service
from chives.server.start_harvester import create_harvester_service
from chives.server.start_introducer import create_introducer_service
from chives.server.start_timelord import create_timelord_service
from chives.server.start_wallet import create_wallet_service
from chives.simulator.block_tools import BlockTools
from chives.simulator.start_simulator import create_full_node_simulator_service
...
async def setup_farmer(
    ...
    service_config["xcc_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "xcc")
