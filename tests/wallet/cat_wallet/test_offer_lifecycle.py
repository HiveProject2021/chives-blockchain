...
class TestOfferLifecycle:
    ...
    async def test_complex_offer(self, setup_sim):
        ...
        try:
            ...
            chives_announcements: List[Announcement] = Offer.calculate_announcements(chives_requested_payments, driver_dict)
            chives_secured_bundle: SpendBundle = generate_secure_bundle(chives_coins, chives_announcements, 1000)
            chives_offer = Offer(chives_requested_payments, chives_secured_bundle, driver_dict)
            ...
            new_offer = Offer.aggregate([chives_offer, red_offer, red_offer_2])
            ...
            assert new_offer.summary() == (
                ...
                {"xcc": 900, str_to_tail_hash("red").hex(): 350},
