...
cd ../chives-blockchain-gui/packages/gui || exit
...
ls -l Chives-darwin-x64/Chives.app/Contents/Resources/app.asar
...
NODE_PATH=./npm_macos/node_modules node build_dmg.js dist/Chives-darwin-x64/Chives.app $CHIVES_INSTALLER_VERSION
LAST_EXIT_CODE=$?
if [ "$LAST_EXIT_CODE" -ne 0 ]; then
