...
def update_version(package_json_path: str):
    ...
    data["version"] = get_chives_version()
...
if __name__ == "__main__":
    update_version(f"{os.path.dirname(__file__)}/chives-blockchain-gui/package.json")
    update_version(f"{os.path.dirname(__file__)}/chives-blockchain-gui/packages/gui/package.json")
