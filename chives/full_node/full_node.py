...
from chives.consensus.blockchain import Blockchain, ReceiveBlockResult, StateChangeSummary
...
from chives.full_node.hint_management import get_hints_and_subscription_coin_ids
...
class FullNode:
    ...
    async def sync_from_fork_point(
        ...
        async def fetch_block_batches(batch_queue: asyncio.Queue, peers_with_peak: List[ws.WSChivesConnection]):
            try:
