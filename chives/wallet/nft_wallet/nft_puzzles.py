...
from chives.wallet.nft_wallet.nft_info import NFTCoinInfo, NFTInfo
...
def metadata_to_program(metadata: Dict[bytes, Any]) -> Program:
    """
    Convert the metadata dict to a Chiveslisp program
    :param metadata: User defined metadata
    :return: Chiveslisp program
    """
    kv_list = []
...
def program_to_metadata(program: Program) -> Dict[bytes, Any]:
    ...
    :param program: Chiveslisp program contains the metadata
