...
from chives.daemon.server import service_launch_lock_path
...
from chives.rpc.rpc_server import start_rpc_server, RpcServer
...
class Service:
    def __init__(
        ...
        *,
        ...
        self._log.info(f"chives-blockchain version: {chives_full_version_str()}")
    ...
    async def setup_process_global_state(self) -> None:
        ...
        proctitle_name = f"chives_{self._service_name}"
