...
import useWalletMasterNodeReceivedLists from '../hooks/useWalletMasterNodeReceivedLists';
...
export default function MasterNodeReceivedList(props: Props) {
  ...
  const {
    ...
    count,
    pageChange,
  } = useWalletMasterNodeReceivedLists(walletId, 10, 0, 'RELEVANCE');
  ...
  return (
    <Card title={<Trans>MasterNode Reward Records</Trans>} titleVariant="h6" transparent>
      <TableControlled
        cols={cols}
        rows={transactions ?? []}
