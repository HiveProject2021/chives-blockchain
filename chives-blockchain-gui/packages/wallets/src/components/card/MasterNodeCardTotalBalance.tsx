...
import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@chives/api-react';
...
export default function MasterNodeCardTotalBalance(props: Props) {
          ...
          <Flex alignItems="center" gap={1}>
            ...
            <TooltipIcon>
              <Trans>
                ...
                This number is generally higher if you have a lot of transactions or canceled offers for XCC, CATs, or NFTs.
