...
import { OfferSummaryRecord } from '@chives/api';
import { useTakeOfferMutation } from '@chives/api-react';
import {
  AlertDialog,
  chivesToMojo,
  useOpenDialog,
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? chivesToMojo(fee) : new BigNumber(0);
