...
import type { NFTInfo, Wallet } from '@chives/api';
import {
...
/*        An NFT offer consists of a single NFT being offered for XCC         */
/* ========================================================================== */
    ...
    >
      ...
      >
        <Tab
          ...
          label={<Trans>NFT for XCC</Trans>}
          disabled={disabled}
        />
        <Tab
          value={NFTOfferExchangeType.XCHForNFT}
          label={<Trans>XCC for NFT</Trans>}
          disabled={disabled}
        />
      </Tabs>
      <Grid container>
...
/* ========================================================================== */
/*                              NFT Offer Editor                              */
/*             Currently only supports a single NFT <--> XCC offer            */
/* ========================================================================== */
...
function buildOfferRequest(
  ...
  const baseMojoAmount: BigNumber = chivesToMojo(xchAmount);
  const mojoAmount =
    exchangeType === NFTOfferExchangeType.NFTForXCH
      ? baseMojoAmount
      : baseMojoAmount.negated();
  const feeMojoAmount = chivesToMojo(fee);
