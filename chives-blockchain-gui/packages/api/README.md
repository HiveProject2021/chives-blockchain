...
This library provides support for TypeScript/JavaScript [Chives](https://www.chivescoin.org) apps to access the [Chives Blockchain RPC](https://github.com/HiveProject2021/chives-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:
